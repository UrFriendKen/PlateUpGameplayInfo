...
namespace KitchenMod.Patches
{
    [HarmonyPatch]
    static class TranspilerTemplate_Patch
    {
        static readonly Type TARGET_TYPE = typeof();
        const bool IS_ORIGINAL_LAMBDA_BODY = false;
        const int LAMBDA_BODY_INDEX = 0;
        const string TARGET_METHOD_NAME = "";
        const string DESCRIPTION = ""; // Logging purpose of patch
